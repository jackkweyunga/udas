...
from django.core.mail.message import EmailMessage as 
...
class EmailMessage(EmailMessage):
    ...
    def __init__(self, subject='', body='', from_email=None, to=None, bcc=None,
        ...
        super().__init__(subject, body, from_email, to, bcc, connection, attachments, headers, cc, reply_to, email_name)
