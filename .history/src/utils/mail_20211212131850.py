...
class EmailMessage(EmailMessage):
    ...
    def __init__(self, subject='', body='', from_email=None, to=None, bcc=None,
        ...
        super().__init__(subject, body, from_email, to, bcc, connection, attachments, headers, cc, reply_to, email_name=None)
    
    def get_connection(self, fail_silently=False):
        if not self.connection:
            self.connection = get_connection(fail_silently=fail_silently, self.email_name)
