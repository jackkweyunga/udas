...
class EmailMessage(EM):
    ...
    def __init__(self, subject='', body='', from_email=None, to=None, bcc=None,
        ...
        super().__init__(subject, body, from_email, to, bcc, attachments, headers, cc, reply_to, connection=self.get_connection())
    
    def get_connection(self, fail_silently=False, email_name=None):
        if not self.connection:
            self.connection = get_connection(fail_silently=fail_silently, email_name=email_name)
