...
from django.core.management.utils import get_random_secret_key
from utils.helpers import create_email_auth_token
...
class DynamicEmailConfiguration(models.Model):
    ...
    api_key = models.CharField(max_length=1024, default=create_email_auth_token)
    ...
    def save(self, *args, **kwargs):
        ...
        self.api_key = create_email_auth_token()
