...
from utils.helpers import get_configuration_admin_url
...
def send_test_email(request):
    ...
    email = request.POST.get('emails', None).split()
    ...
    return HttpResponseRedirect(get_configuration_admin_url('admin'))
